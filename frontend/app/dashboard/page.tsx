...
const stats = [
  ...
  { icon: <Bookmark size={20} className="text-amber-600" />,   label: "Saved Jobs",     value: "3",    change: "View saved", color: "bg-amber-50 border-amber-100" },
  { icon: <CheckCircle2 size={20} className="text-emerald" />, label: "Applied",        value: "3",    change: "Track all",  color: "bg-emerald-light border-emerald/20" },
  { icon: <TrendingUp size={20} className="text-purple-600" />,label: "New This Week",  value: "34",   change: "+8 vs last", color: "bg-purple-50 border-purple-100" },
];
    ...
    <div className="min-h-screen bg-cream pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-emerald mb-1">Overview</p>
          ...
          <div className="flex gap-3">
            <Link
              ...
              target="_blank"
              className="flex items-center gap-2 bg-white border border-warm-gray text-charcoal text-sm font-semibold px-4 py-2.5 rounded-xl hover:border-navy transition-all"
            >
              <Bell size={15} className="text-emerald" />
              Telegram Bot
            </Link>
            <button className="flex items-center gap-2 bg-navy text-white text-sm font-semibold px-4 py-2.5 rounded-xl hover:bg-navy/90 transition-all">
              <RefreshCw size={15} />
              Refresh Jobs
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-warm-gray rounded-2xl p-6">
              <div className="flex items-center justify-between mb-5">
                <h2 className="font-display font-bold text-navy text-lg">Recent Jobs</h2>
          ...
          <div className="space-y-5">
            ...
            {/* Source breakdown */}
            <div className="bg-white border border-warm-gray rounded-2xl p-6">
              <h2 className="font-display font-bold text-navy text-lg mb-5">Jobs by Source</h2>
            ...
            <div className="bg-navy rounded-2xl p-6 text-white">
              ...
              <h3 className="font-display font-bold text-lg mb-2">Daily Job Alerts</h3>
            ...
            {/* Quick links */}
            <div className="bg-white border border-warm-gray rounded-2xl p-6">
              <h2 className="font-display font-bold text-navy text-lg mb-4">Quick Links</h2>
              <div className="space-y-2">
                {[
                  ...
                  { label: "ACBAR Jobs",      href: "https://acbar.org/jobs", external: true },
                ].map((l) => (
                  <Link
                    key={l.label}
                    href={l.href}
