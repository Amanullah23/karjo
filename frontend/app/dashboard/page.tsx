...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      label: t("dash.saved_jobs"),
      value: "3",
      change: t("dash.view_saved"),
      color: "bg-amber-50 border-amber-100",
    },
    {
      icon: <CheckCircle2 size={20} className="text-emerald" />,
      label: t("dash.applied"),
      value: "3",
      change: t("dash.track_all"),
      color: "bg-emerald-light border-emerald/20",
    },
    {
      icon: <TrendingUp size={20} className="text-purple-600" />,
      label: t("dash.new_week"),
      value: "34",
      change: t("dash.vs_last"),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {recentJobs.map((job, i) => (
                    ...
                    >
                      ...
                      <Link
                        href={job.url}
                        target="_blank"
                        className="shrink-0 ms-3 p-2 bg-white border border-warm-gray rounded-lg hover:border-navy transition-all"
                      >
            ...
            <div className="space-y-5">
              ...
              <div className="bg-navy rounded-2xl p-6 text-white">
                ...
                >
                  {t("dash.open_bot")} <ExternalLink size={13} />
                </Link>
              </div>
