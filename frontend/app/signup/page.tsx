    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center px-6 pt-24 pb-16">
        <div className="w-full max-w-md bg-white border border-warm-gray rounded-2xl p-8 text-center">
          ...
          <Link
            href="/login"
            className="inline-block mt-6 text-emerald font-semibold hover:underline text-sm"
          >
            {t("signup.back_login")}
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-6 pt-24 pb-16">
      ...
      >
        ...
        <h1 className="font-display text-3xl font-bold text-navy mb-6">
          {t("signup.title")}
        </h1>
        ...
        <p className="text-[11px] text-warm-muted text-center -mt-2 mb-4">
          {t("signup.google_note")}
        </p>
