      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-8">
          ...
          <p className="text-charcoal/60 text-sm">
            {loading ? "Loading…" : `${appliedJobs.length} applied job${appliedJobs.length !== 1 ? "s" : ""}`}
          </p>
        </div>
        ...
        {!loading && appliedJobs.length === 0 ? (
          <div className="text-center py-24 bg-white border border-warm-gray rounded-2xl">
            ...
            <p className="font-display text-2xl font-bold text-navy mb-2">No applied jobs yet</p>
            <p className="text-warm-muted text-sm mb-6">Mark jobs as applied to track them here.</p>
            <Link
              href="/jobs"
