...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle":
      "KarJo scrapes jobs.af, ACBAR, and LinkedIn every morning and delivers the freshest Afghan opportunities straight to your Telegram.",
    ...
    "feat1.desc":
      "Jobs collected every morning from jobs.af, ACBAR, and LinkedIn — zero manual effort.",
    "feat2.title": "Telegram delivery",
    "feat2.desc":
      "Get fresh Afghan opportunities sent straight to your Telegram at 8 AM every morning.",
    "feat3.title": "Smart filters",
    "feat3.desc":
      "Filter by source, skills, and category. Find the right job in seconds.",
    "feat4.title": "Application tracking",
    "feat4.desc":
      "Save jobs and track every application in one clean dashboard.",
    ...
    "dash.alerts_desc":
      "Get the latest Afghan jobs sent to your Telegram every morning at 8 AM.",
  ...
  fa: {
    ...
    "hero.subtitle":
      "کارجو هر روز صبح وظایف را از jobs.af، ACBAR و LinkedIn جمع‌آوری می‌کند و تازه‌ترین فرصت‌های شغلی را مستقیم به تلگرام شما می‌فرستد.",
    ...
    "features.subtitle":
      "برای کارجویان افغان ساخته شده که خسته‌اند هر روز صبح ۵ وب‌سایت مختلف را باز کنند.",
    "feat1.title": "جمع‌آوری خودکار روزانه",
    "feat1.desc":
      "وظایف هر روز صبح از jobs.af، ACBAR و LinkedIn جمع‌آوری می‌شود — بدون هیچ تلاشی.",
    "feat2.title": "ارسال به تلگرام",
    "feat2.desc":
      "تازه‌ترین فرصت‌های شغلی افغانستان هر روز ساعت ۸ صبح مستقیم به تلگرام شما فرستاده می‌شود.",
    "feat3.title": "فیلترهای هوشمند",
    "feat3.desc":
      "بر اساس منبع، مهارت‌ها و دسته‌بندی فیلتر کنید. وظیفه مناسب را در چند ثانیه پیدا کنید.",
    "feat4.title": "پیگیری درخواست‌ها",
    "feat4.desc":
      "وظایف را ذخیره کنید و همه درخواست‌هایتان را در یک داشبورد مرتب پیگیری کنید.",

    // CTA section
    "cta.title1": "وظایف در تلگرام شما،",
    "cta.title2": "هر روز صبح.",
    "cta.subtitle":
      "ربات کارجو را شروع کنید و هر روز ساعت ۸:۰۰ صبح تازه‌ترین فرصت‌های شغلی افغانستان را دریافت کنید — بدون ثبت‌نام، بدون هزینه، برای همیشه رایگان.",
    ...
    "dash.alerts_desc":
      "هر روز ساعت ۸ صبح تازه‌ترین وظایف افغانستان به تلگرام شما فرستاده می‌شود.",
    ...
    "profile.telegram_hint":
      "حساب @Kar_Jo_Bot خود را برای همگام‌سازی لینک کنید.",
    ...
    "saved.empty_sub":
      "وظایفی که علاقه دارید را نشانه‌گذاری کنید تا اینجا نمایش داده شوند.",
    ...
    "applied.empty_sub":
      "وظایفی که برایشان درخواست داده‌اید را علامت‌گذاری کنید تا اینجا پیگیری شوند.",
    ...
    "signup.email_note":
      "فرستادیم. روی آن کلیک کنید تا حسابتان فعال شود، سپس وارد شوید.",
